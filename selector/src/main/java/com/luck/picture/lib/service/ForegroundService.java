...
public class ForegroundService extends Service {
    private static final String CHANNEL_ID = "LIBRARY_PACKAGE_NAME." + ForegroundService.class.getName();
//    private static final String CHANNEL_ID = BuildConfig.LIBRARY_PACKAGE_NAME + "." + ForegroundService.class.getName();
    private static final String CHANNEL_NAME = "LIBRARY_PACKAGE_NAME";//BuildConfig.LIBRARY_PACKAGE_NAME;
