...
public class PictureSelectorFragment extends PictureCommonFragment
    ...
    public String getInputMsg() {
        return TextUtils.isEmpty(etInputMsg.getText()) ? "" : etInputMsg.getText() + "";
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        etInputMsg = view.findViewById(R.id.etInputMsg);
        onCreateLoader();
        ...
        etInputMsg.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
