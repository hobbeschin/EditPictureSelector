...
public class PictureSelectorEngineImp implements PictureSelectorEngine {
    ...
    public PictureSelectorEngineImp() {
        Log.e(TAG, "PictureSelectorEngineImp: 图片选择，加载了相机胶卷");
    }
            ...
            public int getLayoutResourceId(Context context, int resourceSource) {
                switch (resourceSource) {
                    case InjectResourceSource.MAIN_SELECTOR_LAYOUT_RESOURCE:
                        Log.e(TAG, "OnInjectLayoutResourceListener: 图片选择，加载了相机胶卷--PictureSelectorEngineImp--ps_custom_fragment_selector布局");
